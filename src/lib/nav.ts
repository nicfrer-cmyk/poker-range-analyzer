...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/ai-review", label: "ניתוח AI", icon: "sparkle", section: "tools" },
  ...
  { href: "/range-vs-range", label: "טווח מול טווח", icon: "compare", section: "tools" },
  { href: "/icm", label: "מחשבון ICM", icon: "calculator", section: "tools" },
  { href: "/bankroll", label: "מעקב בנקרול", icon: "wallet", section: "tools" },
